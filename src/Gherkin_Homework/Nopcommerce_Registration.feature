Feature: Nopcommerce Registration
  As a user i want to the check registration functionality of Nopcommerce

  Background: I am on Nopcommerce registration page
    Given I open the Google chrome browser
    When  I open the Url https://demo.nopcommerce.com/registration
    ...
    Scenario Outline: I should not be able to register with invalid data on mandatory field (*) on registration page
      ...
      | Rohan      |bakshi     |bakshi@gmail.com|456897    |456987            |password and confirm password do not match|
      ...
      Scenario: I should be able to select any one radio button from Gender lable of Your Personal details section
        ...
        Scenario Outline: I should be able to select Day,Month and Year from drop down list of Date of Birth field
          ...
          Then   I am able to see Day,Month and Year from drop down list
          Examples:
          | Day |  Month   | Year |
          | 11  | November | 1989 |
